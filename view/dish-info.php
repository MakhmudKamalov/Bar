...
<head>
  ...
  <title>Инфо о ингредиентах</title>
  <!-- General CSS Files -->
...
$workers = $obj->table('dish_ingredients','ing_id','quantity','type')->where('dish_id', $id)->get();
...
?>
    ...
    <div class="card">  
      <div class="card-header">
        ...
        <h4>Ингредиенты  <?php echo $_GET['name']; ?></h4>
      </div>
      <div class="card-body">
