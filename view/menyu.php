        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <li><a class="nav-link" href="./menyu.php"><b>Наш меню</b></a></li>
...
$workers = $obj->table('dishes')->where('status',1)->get();
rsort($workers);
...
?>
    ...
    <div class="card">  
      <div class="card-header">
        ...
        <h4>Наш меню</h4><h4>>></h4>
        <p><h4><a href="#" style="color:black "><u>Все</u></a></h4></p><h4>-</h4>
          <p><h4><a href="#">Салаты</a></h4></p><h4>-</h4>
          <p><h4><a href="#">Первые блюда</a></h4></p><h4>-</h4>
          <p><h4><a href="#">Вторые блюда</a></h4></p>
      </div>
      <div class="card-body">
      <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          <td><?= $i++; ?></td>
                          <td><a href="./dish-info.php?id_info=<?= $v['id'];  ?>&name=<?= $v['name'];  ?>" style="color:black"><?= $v['name']; ?></a></td>
                          <td><?= $v['info']; ?></td>
                          <td><?php if($v['category'] == 0){ echo 'Салаты';  }elseif($v['category'] == 1){ echo 'Первые блюда'; }else{ echo 'Вторые блюда'; }; ?></td>
                          <td><?= $v['price']; ?></td>
                          <td>
                          <a href="./add-ing.php?id_edit=<?= $v['id'];  ?>&name=<?= $v['name'];  ?>" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
                          <a  href="./del-dishes.php?id=<?= $v['id'];  ?>" class="btn btn-danger btn-action" data-toggle="tooltip" title="" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="alert('Deleted')" data-original-title="Delete"><i class="fas fa-trash"></i></a> 
                          </td> 
                        <?php
                        }
                        ?>
