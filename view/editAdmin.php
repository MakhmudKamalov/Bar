          ...
          <div class="section-body">
            ...
            if (isset($_GET["edit_id"])) {
                ...
                if ($_SERVER["REQUEST_METHOD"]=="POST") {
                    ...
                    $sql_admins="UPDATE `workers` SET `name`='$name',`surname`='$surname',`phone`='$phone',`level`='$level',`login`='$login',`password`='$password' WHERE `id`='$id'" ;
                    mysqli_query($db,$sql_admins);
                  ...
                  <div class="card-body">
                         <div class="row">
                          ...
                          <div class="col-2">
                              <div class="form-group">
                                <label>Lawazim</label>
                                <select class="form-control" name="level" required="" value="<?=$admins[0]["level"]?>">
                                  <option value="1">Admin</option>
                                  <option value="2">Offitsiant</option>
                        ...
                        <div class="col-3">
                          <div class="form-group">
                            <label>Password</label>
                                <input type="password" class="form-control form-control-sm" name="password" required="" value="<?=$admins[0]["password"]?>">
                          </div>
                        </div>  
                        <div class="col-3"></div>               
                    </div>
                    <div class="form-group text-right">
                         <input class="btn btn-primary" type="submit" value="Edit" name="Dizim"> 
