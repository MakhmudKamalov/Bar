        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="index.php" class="menu-toggle nav-link has-dropdown toggled"><i
                  data-feather="users"></i><span>Сотрудники</span></a>
              <ul class="dropdown-menu active">
                <li><a class="nav-link" href="allAdmin.php">Все сотрудники</a></li>
                <li><a class="nav-link" href="addAdmin.php"><b>Добавить сотрудника</b></a></li>
              </ul>
            </li>
          ...
          <div class="section-body">
            ...
            $db=mysqli_connect("localhost","root","root","west-pub");
              ...
              if (isset($_GET["edit_id"])) {
                ...
                $id=$_GET["edit_id"];
                $sql1="SELECT * FROM `workers` WHERE `id`='$id'";
                $response=mysqli_query($db,$sql1);
                ...
                if ($_SERVER['REQUEST_METHOD'] == "POST") {
                  ...
                  $sql1="UPDATE `workers` SET `name`='$name',`surname`='$surname',`phone`='$phone',`level`='$level',`login`='$login',`password`='$password' WHERE `id`='$id'";
            ...
            <form action="" method="POST">
                  ...
                  <div class="card-body">
                         <div class="row">
                          ...
                          <div class="col-2"> 
                              <div class="form-group">
                                  <label>Имя </label>
                                  <input type="text" class="form-control " name="name" required="" value="<?=$admins[0]["name"]?>">
                              </div>
                          </div>
                          <div class="col-2">
                              <div class="form-group">
                                  <label>Фамилия</label>
                                  <input type="text" class="form-control" name="surname" required="" value="<?=$admins[0]["surname"]?>">
                              </div>
                          </div>
                          <div class="col-2">
                              <div class="form-group">
                                  <label>Тел</label>
                                  <input type="number" class="form-control" name="phone" required="" value="<?=$admins[0]["phone"]?>">
                              </div>
                          </div>
                    ...
                    <div class="row">  
                      <div class="col-3"></div>               
                        <div class="col-3">
                          <div class="form-group">
                              <label>Логин</label>
                              <input type="login" class="form-control form-control-sm" name="login" required="" value="<?=$admins[0]["login"]?>">
                          </div>
                        </div>
                        ...
                        <div class="col-3">
                          <div class="form-group">
                            <label>Пароль </label>
                                <input type="text" class="form-control form-control-sm" name="password" required="" value="<?=$admins[0]["password"]?>">
                          </div>
                        </div>  
                        <div class="col-3"></div>               
                    </div>
                    <div class="form-group text-right">
                      ...
                      ?>
                         <input class="btn btn-success" type="submit" value="Сохранить" name="edit"> 
                      <?php
                        }
                        ?>
                    </div>
              ...
              <?php
                ...
                if (isset($_POST["Dizim"])) {
                  require("addAdminCon.php");
                  addAdmin($_POST);
                ...
                <form action="" method="POST">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">  
                          <div class="col-3"></div>               
                            <div class="col-3">
                              <div class="form-group">
                                  <label>Логин</label>
                                  <input type="login" class="form-control form-control-sm" name="login" required="" >
                              </div>
                            </div>
                        ...
                        <div class="form-group text-right">
                             ...
                             <input class="btn btn-primary" type="submit" value="Добавить" name="Dizim"> 
