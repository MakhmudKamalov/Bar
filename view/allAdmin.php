          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu active">
                <li><a class="nav-link" href="allAdmin.php"><b>Все сотрудники</b></a></li>
...
if (isset($_GET["id"])) {
  ...
  $id = $_GET["id"];
  $sql_admin="DELETE FROM `workers` WHERE `id`='$id'";
  mysqli_query($db,$sql_admin);
}
  
$obj= new mysql('root','root','west-pub');
$workers = $obj->table('workers')->get();
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          ...
                          <td><?= $v['phone']; ?></td>
                          <td><?php if($v['level'] == 1){ echo "Admin";  }elseif($v['level'] == 2){ echo "Officiant";   }else{ echo "Kassir";  }; ?></td>
                          <td><?= $v['login']; ?></td>
                          <td><?= $v['password']; ?></td>
                          <td><?= $v['date'].' '.$v['time']; ?></td>
                          <td>
        <a href="addAdmin.php?edit_id=<?=$v["id"]?>" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
        <a  href="allAdmin.php?id=<?=$v["id"]?>" class="btn btn-danger btn-action" data-toggle="tooltip" title="" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="alert('Deleted')" data-original-title="Delete"><i class="fas fa-trash"></i></a>
