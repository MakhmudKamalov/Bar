...
if(isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM stocks WHERE id = $item_id";
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="widget-chart.html">Все сотрудники</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="widget-data.html">Добавить в меню</a></li>
                <li><a class="nav-link" href="widget-data.html">Изменить меню</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="editstock.php">Изменение склада </a></li>
              </ul>
            </li>
          ...
          <div class="section-body">
            ...
            <div class="card">
                  <div class="card-header">
                    ...
                    <h4>Изменение склада</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                    <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
                      <label>Название продукта</label>
                      <input type="text" class="form-control" name="item_name" value="<?php echo $item['item_name']; ?>" required id="item_name">
                    </div>
                    <div class="form-group">
                      <label>Обьем продукта</label>
                      <input type="number" class="form-control" min="1" name="item_quantity" value="<?php echo $item['item_quantity']; ?>" required id="item_quantity">
                    </div>
                    <div class="form-group">
                      <label>Тип измерение</label>
                      <select class="form-control" name="item_type" value="<?php echo $item['item_name']; ?>" required id="item_type">
                        <option>штук</option>
                        <option>грамм</option>
                        <option>кг</option>
                        <option>литр</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" min="1000" name="item_price" value="<?php echo $item['item_price']; ?>" required id="item_price">
                    </div>
                  </div>


                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" type="submit">Изменить</button>
                  </div>
                </div>
                </form>
...
<?php
        ...
        echo "Error: Unable to fetch item details";
    }
} else {
