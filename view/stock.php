        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <li><a class="nav-link" href="stock.php"><b>Все продукты</b></a></li>
                ...
                <tbody>
                    ...
                    foreach ($data as $v) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $v['start'].' '. $v['start_time']; ?></td>
                            <td><a href="edit_item.php?id=<?= $v['id']; ?>" class="btn btn-primary">Изменить</a></td>
                            <td><a href="del_item.php?id=<?= $v['id']; ?>" class="btn btn-danger">Удалить</a></td>
                        </tr>
                    <?php
                    }
                    ?>
